...
| Налог | За что платится | Кому актуален | Ключевые пороги |
| --- | --- | --- | --- |
| Einkommensteuer | Доходы (чистая прибыль) | Все | Grundfreibetrag ~12 096 €; прогрессия до 42/45% |
| Umsatzsteuer | Оборот (НДС) | Все, кроме KUR | KUR: ≤25k прошлый, ≤100k текущий; Voranmeldung: >9k/год — месяц |
| Gewerbesteuer | Прибыль Gewerbe | Только Gewerbe | Freibetrag ~24 500 €; ставка по Gemeinde |
| Solidaritätszuschlag | Доп. сбор к ESt | При высоком доходе | Взимается с части ESt (см. Bescheid) |
| Kirchensteuer | Для членов церкви | При членстве | 8–9% от ESt |
