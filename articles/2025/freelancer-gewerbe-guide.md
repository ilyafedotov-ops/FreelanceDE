...
| --- | --- | --- | --- | --- | --- |
| Einkommensteuer | Чистая прибыль | Все | Grundfreibetrag ~12 096 €; прогрессия до 42/45% | Годовая декларация, авансы поквартально | Формулы: Grundtabelle BMF |
...
Формулы (Grundtabelle) и калькулятор BMF: <https://www.bmf-steuerrechner.de/ekst/eingabeformekst.xhtml>
