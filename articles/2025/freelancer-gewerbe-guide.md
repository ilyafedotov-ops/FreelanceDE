...
- В Германии учитываются три величины сразу:
  ...
  3. лимит страны покупателя (но не выше 85 000 €), если продаёте B2C в другую страну ЕС.
...
- тем, кто продаёт B2C в другие страны ЕС и хочет избежать отдельных НДС-регистраций;
